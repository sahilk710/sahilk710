        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <div className="what-content-flex">
                <div className="what-tags">LLMs &amp; Prompt Eng.</div>
                <div className="what-tags">RAG Pipelines</div>
                <div className="what-tags">Knowledge Graphs</div>
                <div className="what-tags">NLP &amp; BERT</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Pipelines, Cloud & Analytics</h4>
              <p>
                Designing and deploying end-to-end data pipelines, ML models,
                and interactive dashboards on cloud platforms—production-ready
                systems that drive real business decisions.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Python</div>
                <div className="what-tags">AWS SageMaker</div>
                <div className="what-tags">SQL &amp; dbt</div>
